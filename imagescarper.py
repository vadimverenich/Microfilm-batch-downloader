...
profile = {"download.default_directory": "C:\\Users\\vadim\\Downloads\\",
           "download.prompt_for_download": False,
           "download.directory_upgrade": True}

chrome_profile.add_experimental_option("prefs", profile)
chrome_profile.add_argument("--disable-extensions")
driver = webdriver.Chrome(executable_path="C:\\Users\\vadim\\Downloads\\chromedriver.exe", chrome_options=chrome_profile,service_args=["--log-path=C:\\Users\\vadim\\Downloads\\chromedriver.log"],  desired_capabilities=dc)
